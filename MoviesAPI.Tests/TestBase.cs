...
namespace MoviesAPI.Tests
{
    public class TestBase
    {
       protected string rolAdminId = "9aae0b6d-d50c-4d0a-9b90-2a6873e3845d";
        ...
        protected WebApplicationFactory<Startup> BuildWebAppFactory(string dbName, bool ignoreSecurity = true) { 
            ...
            factory = factory.WithWebHostBuilder(builder => {
                ...
                builder.ConfigureTestServices(services => {
                    ...
                    var descriptorDBContext = services.SingleOrDefault(a => a.ServiceType == typeof(DbContextOptions<ApplicationDbContext>));
                    ...
                    if (ignoreSecurity) {
                        ...
                        services.AddSingleton<IAuthorizationHandler, AllowAnoymousHandler>();
                        services.AddControllers(options => { 
                        
                            options.Filters.Add(new FalseUserFilter()); 
                        });
                    }
                });
            });
